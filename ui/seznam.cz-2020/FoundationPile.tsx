    ...
    <div className={style.pile}>
      <div className={style.card}>
        ...
        {color === Color.DIAMONDS &&
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 120'><path d='M8 0h64c4.432 0 8 3.568 8 8v104c0 4.432-3.568 8-8 8H8c-4.432 0-8-3.568-8-8V8c0-4.432 3.568-8 8-8z' fill={lightColor}/><path d='M10 6h60c2.216 0 4 1.784 4 4v100c0 2.216-1.784 4-4 4H10c-2.216 0-4-1.784-4-4V10c0-2.216 1.784-4 4-4z' fill={darkColor}/><path d='M68 64a28 28 0 01-28 28 28 28 0 01-28-28 28 28 0 0128-28 28 28 0 0128 28z' fill={lightColor}/></svg>
        }
        {color === Color.HEARTHS &&
